...
def train(model, optimizer, train_data, criterion, epoch, z=None, verbose="n"):
    """
    train the model.
    ...
    :param verbose: print number of edges after modified in every iteration if set to y.
    """
    ...
    if verbose == "y":
        print(f"Number of edges after added from the model: {pos_edge_index.shape[1]}")
